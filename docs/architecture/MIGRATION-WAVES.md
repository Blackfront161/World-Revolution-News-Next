...
Aktueller Fortschritt (28. August 2026): G3-014 ist mit Kandidat `44b5cb1`,
QA `999b777` und Architektur `0b2bd2f` technisch GREEN und durch PO-073
visuell akzeptiert. PO-074 startet das mit PO-072 vorbereitete G3-015: nur Website-
Shell, eigener SW-/Cachevertrag, Web-Offline-Neustart, Update und Paketrollback.
Zuerst P1-Vertragsreview. Android-Shell und weitere MUST-Teile bleiben getrennt offen.
Der folgende Absatz beschreibt den historischen Vorbereitungsstand vor PO-071.

Konkretisierung vom 28. August 2026 (PO-070, nur Vorbereitung): G3-011
lieferte lokalen Lesestatus; G3-012 den validierten Releaseverbraucher;
G3-013 die vom Product Owner priorisierte UI-Sprachwahl. G3-014 plant jetzt
explizit gespeicherte Inhaltsrevisionen, atomaren Wechsel, Rueckwechsel und
Revocationschutz in getrennten IDB-Datenbanken. Website-Shellcache/Service
Worker, echter Offline-Kaltstart, Android, Hilfe-Offlinepakete und echte
Legacy-/Nutzerdatenmigration bleiben eigene spaetere Slices. Diese Zerlegung
streicht keine MUST-Funktion und erklaert Wave 4 nicht vorzeitig als erledigt.
