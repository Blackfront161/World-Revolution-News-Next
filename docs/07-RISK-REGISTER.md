...
| R-09 | Medienquellen oder Rechte sind unklar | rechtliche/produktive Risiken | Provenienz- und Lizenzregister vor Uebernahme | Product Owner / G2 | Register erstellt; Qood blockiert, Marken-/Medienrechte offen |
...
| R-18 | fehlende Lizenz fuer Code/Assets/Fonts | Veroeffentlichungsrisiko | Rechteaudit vor Kopieren und G5 | Security/Product Owner | Qood-Lizenz unvereinbar; kein pauschaler Legacy-Import |
...
| R-09/R-18 Rechte | Asset-/Medienregister mit Ursprung, Lizenz, Nutzung und Hash; kein Import ohne Beleg | Product Owner + Security | vor jedem Import/G5 | Register erstellt; Qood blockiert, Marken-/Medienbelege offen |
