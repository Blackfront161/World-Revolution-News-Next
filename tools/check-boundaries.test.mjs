...
test('permits service API-contract imports but rejects client and test-support imports', () => {
  withWorkspaceFixture(
    {
      'services/translation/src/handler.ts':
        'import "@wrn/api-contracts/translation-v1";\nimport "@wrn/mobile";\nimport "@wrn/test-support";\nimport "../../../apps/website/src/main.ts";\n',
      'apps/website/src/main.ts': 'export {};\n',
    },
    (fixtureRoot) => {
      const violations = findBoundaryViolations(fixtureRoot);
