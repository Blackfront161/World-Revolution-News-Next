"""Create deterministic WRN-G3-002 visual acceptance contact sheets.
...
def comparison_sheet(
    ...
    for row, legacy, candidate in rendered:
        ...
        draw.text(
            ...
            "NEU · lokale Manifest-v1-Vorschau",
            fill=MUTED,
            font=font(16),
        )
        y += 66
...
def main() -> None:
    ...
    candidate = root / "docs/evidence/WRN-G3-002/new"
    output = root / "docs/evidence/WRN-G3-002/contact-sheets"
