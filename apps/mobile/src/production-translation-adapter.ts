...
export const createMobileProductionTranslationAdapter = createProductionTranslationAdapter;
export const productionTranslationAdapter = createMobileProductionTranslationAdapter({
